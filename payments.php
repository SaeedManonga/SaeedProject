        ...
        <div class="card-body">
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT id, ClientId, PropertyId, AmountPaid, Balance, DATE_FORMAT( date, '%D %M, %Y') AS date FROM property_revenu WHERE ClientId = '$SessionId'");
                    //     SELECT
                    // 	`property`.`PropertyId`,
                    // 	`property_revenu`.`id`,
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <a href="./index.php?page=view_payment&payId=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat print_payment">RECEIPT
                                    </a>
                                </div>
                            </td>
                        </tr>
