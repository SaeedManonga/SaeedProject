        ...
        <div class="card-body" id="print_div">
            <div class="row">
                ...
                <div class="receipt-main col-xs-12 col-sm-12 col-md-12 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <h3>
                        <center>MARKET PAYMENT</center>
                        <img src=" img/IMG_20220504_182359_7.jpg" style="padding:2px; " alt="">
                    </h3>
                    <div class="row">
                        <div class="receipt-header receipt-header-mid">
                            <div class="col-xs-12 col-sm-12 col-md-12text-left">
                                <div class="receipt-right">
                                    <h5>CLIENT NUMBER.:<?php echo $rs['Mobile']; ?> </h5>
                                    <h5>CLIENT NAME.: <?php echo $rs['ClientName']; ?> </h5>
                        ...
                        <table width="100%" style="border-color: #e4dddd;" border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right; padding-right:20px;">
                                        <strong><i class="fa fa-inr"></i>MK <?php echo $rs['Balance']; ?></strong>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="footer-text">
                        ...
                        <p>
                            <center>&copy;2021, .all rights reserved</center>
                        </p>
                        <i>
