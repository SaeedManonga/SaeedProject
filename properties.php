                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>MK <?php echo $row['AmountPayable'] ?></td>
                            <td>MK <?php echo $row['AmountPaid'] ?></td>
                            <td>MK <?php echo $row['CurrentBalance'] ?></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="./index.php?page=property_details&proId=<?php echo $row['PropertyId'] ?>" class="btn btn-primary btn-flat make_payment">VIEW
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <a href="./index.php?page=step1&proId=<?php echo $row['PropertyId'] ?>" class="btn btn-success btn-flat make_payment">PAY
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <a href="./index.php?page=manage_property&proId=<?php echo $row['PropertyId'] ?>" class="btn btn-warning btn-flat make_payment">REMOVE
                                    </a>
                                </div>
        </div>
        </td>
